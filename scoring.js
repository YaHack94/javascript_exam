...
$(document).ready(function () {
  ...
  function get_achievement() {
    ...
    let averageIndicate = score_indicate() / 5 ;
  ...
  function get_pass_or_failure() {
    ...
    let judge = "Pass !";
    if (subject_points[0] >= 60 && subject_points[1] >= 60 && subject_points[2] >= 60 &&
    subject_points[3] >= 60 && subject_points[4] >= 60) {
      return judge;
    }
    else {
      return "Fail !";
  ...
  function judgement() {
    ...
    $('#declaration').append(`<label id="alert-indicate" class="alert alert-info">Your grade is${achievement}. And you ${pass_or_failure}.</label>`);
  };
